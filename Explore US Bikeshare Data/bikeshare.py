...
def get_filters():
    ...
    while True:    
        month = input("Which month would you like to explore ('january', 'february', 'march', 'april', 'may', 'june', 'all')?")
        month = month.lower()
    ...
    while True:
        day = input("Which day would you like to explore ('monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday', 'all')?")
        day = day.lower()
